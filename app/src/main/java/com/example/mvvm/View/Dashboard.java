...
import com.example.mvvm.Fragments.Games.FragmentAllGames;
import com.example.mvvm.Fragments.Events.FragmentSeriesGames;
import com.example.mvvm.Fragments.Series.FragmentSeries;
import com.example.mvvm.Fragments.Standings.FragmentStandings;
import com.example.mvvm.Fragments.Teams.FragmentTeams;
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                ...
                case R.id.navigation_games:
                    if (fragmentStatus.equals("Games")) {
                        exitCount = 0;
                    } else {
                        fragmentStatus = "Games";
                        exitCount = 0;
                        FragmentAllGames fragmentAllGames = new FragmentAllGames();
                        FragmentManager managerAllGames = getSupportFragmentManager();
                        managerAllGames.beginTransaction().replace(R.id.dashboard_frameLayout, fragmentAllGames, fragmentAllGames.getTag()).commit();
                    }
                    return true;
            }
            return false;
